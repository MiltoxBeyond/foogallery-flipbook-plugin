...
return a.$items=[],a.selectedItem=null,this.$el.find(".ui-menu-wrapper").children().remove(),this.$el},u.prototype.options=function(b){var c=this._data;return void 0===b?c.options:(c.options=a.extend(c.options,b),void 0)},b.widgetFactory("menu",u)}($);